    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        public class MovementSettings
        {
            ...
            public void UpdateDesiredTargetSpeed(Vector2 input)
            {
				...
				{
					//forwards
					//handled last as if strafing and moving forward at the same
					//time forwards speed should take precedence
        ...
        public class AdvancedSettings
        {
            ...
            // ( 0.01f seems to work best for this )
            ...
            //reduce the radius by that ratio to avoid getting stuck in wall
            //(a value of 0.1f is nice)
